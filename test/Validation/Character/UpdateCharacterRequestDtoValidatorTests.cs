...
{
    public class UpdateCharacterRequestDtoValidatorTests
    {
        private readonly UpdateCharacterRequestDtoValidator validator;

        public UpdateCharacterRequestDtoValidatorTests()
        {
            validator = new UpdateCharacterRequestDtoValidator();
        }
        ...
        {
            //Arrange
            var dto = new UpdateCharacterRequestDto
            {
                Id = 1,
                Name = "Yoda",
                HitPoints = 50,
